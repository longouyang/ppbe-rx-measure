...
```{r}
ggplot(data = score.by.stim %>% filter(rule.id == '3a')) +
  geom_line(mapping = aes(x = string, y = mean.score, group = seq.id, color = seq.id))
```

zip-code:
```{r}
ggplot(data = score.by.stim %>% filter(rule.id == 'zip-code')) +
  geom_line(mapping = aes(x = string, y = mean.score, group = seq.id, color = seq.id))
```
...
```{r}
ggplot(data = score.by.stim %>% filter(rule.id == 'consonants-only')) +
  geom_line(mapping = aes(x = string, y = mean.score, group = seq.id, color = seq.id))
```
...
```{r}
ggplot(data = score.by.stim %>% filter(rule.id == 'delimiters')) +
  geom_line(mapping = aes(x = string, y = mean.score, group = seq.id, color = seq.id))
```
